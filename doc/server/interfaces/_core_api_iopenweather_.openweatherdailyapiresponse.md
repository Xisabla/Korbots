[korbots-server](../README.md) › [Globals](../globals.md) › ["core/API/IOpenWeather"](../modules/_core_api_iopenweather_.md) › [OpenweatherDailyAPIResponse](_core_api_iopenweather_.openweatherdailyapiresponse.md)
...
*Defined in [src/core/API/IOpenWeather.ts:124](https://github.com/Xisabla/Korbots/blob/c8927cf/server/src/core/API/IOpenWeather.ts#L124)*
