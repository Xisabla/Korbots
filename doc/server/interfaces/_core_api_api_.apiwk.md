...
*Defined in [src/core/API/API.ts:6](https://github.com/Xisabla/Korbots/blob/4e41610/server/src/core/API/API.ts#L6)*
...
*Defined in [src/core/API/API.ts:8](https://github.com/Xisabla/Korbots/blob/4e41610/server/src/core/API/API.ts#L8)*
...
*Defined in [src/core/API/API.ts:16](https://github.com/Xisabla/Korbots/blob/4e41610/server/src/core/API/API.ts#L16)*
...
*Defined in [src/core/API/API.ts:4](https://github.com/Xisabla/Korbots/blob/4e41610/server/src/core/API/API.ts#L4)*
