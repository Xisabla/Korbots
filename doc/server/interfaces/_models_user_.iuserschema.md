...
*Defined in [src/models/User.ts:14](https://github.com/Xisabla/Korbots/blob/84c1655/server/src/models/User.ts#L14)*
...
*Defined in [src/models/User.ts:15](https://github.com/Xisabla/Korbots/blob/84c1655/server/src/models/User.ts#L15)*
...
*Defined in [src/models/User.ts:13](https://github.com/Xisabla/Korbots/blob/84c1655/server/src/models/User.ts#L13)*
