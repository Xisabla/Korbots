...
*Defined in [src/models/User.ts:26](https://github.com/Xisabla/Korbots/blob/7fbbf5f/server/src/models/User.ts#L26)*
...
*Defined in [src/models/User.ts:3](https://github.com/Xisabla/Korbots/blob/7fbbf5f/server/src/models/User.ts#L3)*
